...
//         model: "Camry"
//     }
//     , {make: "Ford", model: "F-150"}, {make: "Tesla", model: "Model S"} ]

const messages = ['messages!!!']; // const userStateeeeee = [];
app.post('/messages', async (request, response) => {
    console.log(Object.keys(request.body));
    const result = {status: 'error!!!'}
    response.status(700).send(JSON.stringify(result)).end();
});

// const messages = [
//     {
//         user: 'anya@ivanova',
//         message: 'Hello from Anya',
